...
void login_page()
{
    ...
    fill_rect(240,550,360,600,MARINE_BLUE,BLACK);
    puthz(268,558,"登录",32,35,'K',WHITE);
    puthz(108,359,"账号",32,35,'K',WHITE);
    puthz(108,459,"密码",32,35,'K',WHITE); //画登录框图

    fill_rect(115,630,235,680,MARINE_BLUE,BLACK);
    fill_rect(365,630,485,680,MARINE_BLUE,BLACK);
    puthz(125,643,"新人注册",24,25,'K',WHITE);
    puthz(375,643,"找回密码",24,25,'K',WHITE); //画找回和注册界面
...
void exit_window()
{
    ...
    puthz(267,begposi+100,"确定退出本程序吗",32,35,'H',BLACK);
